...
<body>
	 ...
	 <fieldset>
              <legend align="center"><h1> Delete Menu </h1></legend>
	    <div class="center">
		...
		<tr align="center ">
			...
			<td> <input type="text" name="price" value="<?php echo $foodmenu["price"];?>" class ="form-control" placeholder="Food Price" ></td>
		</tr>
		...
		<tr>
			<td colspan="3"><input class="my-font btn-mine" type="submit" name="delete_menu" value="Delete"></td>
		</tr>
